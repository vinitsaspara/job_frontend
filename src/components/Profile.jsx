  ...
  return (
    <div>
      ...
      <div className="max-w-4xl shadow-lg mx-auto bg-white border border-gray-100 rounded-md my-5 p-8">
        <div className="flex justify-between">
          <div className="flex items-center gap-4">
            <Avatar className="h-24 w-24">
              <AvatarImage src="https://imgs.search.brave.com/68f9Ql2VSS1Jq1s4cg-w6La7HZnxeMfJHy-QZHqsVeM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzAzLzI3Lzk5LzQ4/LzM2MF9GXzMyNzk5/NDgwNV8xRzBiQkVp/TXg5eVR6MFZCNXZF/elFyOWRFVWcwVGxC/TC5qcGc"></AvatarImage>
            </Avatar>
            <div>
        ...
        <div className="my-5">
          <h1 className="font-medium text-lg mb-1">Skills</h1>
