        ...
        <div className="flex items-center gap-12">
          ...
          !user ? (
            <div className="flex gap-2">
              <Link to="/login"><Button className="bg-[#903b3b] hover:bg-[#be5555]" veriant="outline">Login</Button></Link>
              <Link to="/signup"><Button className="bg-[#903b3b] hover:bg-[#be5555]" veriant="outline">Sign Up</Button></Link>
            </div>
          ) : (
            <Popover>
